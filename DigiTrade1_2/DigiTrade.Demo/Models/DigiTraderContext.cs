...
{
    public partial class DigiTraderContext : DbContext
    {
        public DigiTraderContext()
        {
        }

        public DigiTraderContext(DbContextOptions<DigiTraderContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=MUG; Database=DigiTrader; Trusted_Connection=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                //entity.Property(e => e.PurPrice).HasColumnName("pur_price");
